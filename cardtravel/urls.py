...
from .views import TradesView, TradeView, TradeListView, TradeCardView
from .views import AddTrade, EditTrade, DeleteTrade
...
urlpatterns = patterns('',
    ...
    url(r'^edit_profile/$', 'cardtravel.views.edit_profile', 
        name = 'edit_profile'),
    url(r'^change_password/$', 'cardtravel.views.change_password', 
    ...
    url(r'^tradelist/(?P<user_id>\d+)/$', TradeListView.as_view(), 
        name = 'view_tradelist'),
    url(r'^trades/edit/(?P<trade_id>\d+)/$', EditTrade.as_view(), 
        name = 'edit_trade'),
    url(r'^trades/response/(?P<trade_id>\d+)/$', 
        'cardtravel.views.response_trade', name = 'response_trade'),
    url(r'^trades/delete/(?P<trade_id>\d+)/$', DeleteTrade.as_view(), 
        name = 'delete_trade'),
    url(r'^trades/card/(?P<card_name>\d+)/$', TradeCardView.as_view(),
        name = 'view_trade_card'),
